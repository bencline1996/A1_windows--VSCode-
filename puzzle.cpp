...
int Puzzle::h(heuristicFunction hFunction){
	...
	switch(hFunction){
		...
		case misplacedTiles:			      
				// Number of tiles in the wrong place (NOT INCLUDING THE BLANK TILE 0)
				//place your implementation here	
                h = numOfMisplacedTiles; 					
		        break;
		         
		case manhattanDistance:
				// Sum of tile distance from its goal location - Manhattan Distance between (x1, y1) and (x2, y2) is │x1 – x2│ and │y1 – y2│
				//place your implementation here
